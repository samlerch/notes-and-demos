...
@RestController //Automatically infers the return value of all method will be within an HttpResponseBody
...
public class UserController {
	...
	// Now for our methods we'll specify annotations that work with specific http verbs
	...
	// Now everything below is not necessarily best practice but it'll be useful to show
	
	// Another way we COULD search is with request/query parameters
	// Though you should save this just for filtering data
	
	@GetMapping("findQuery") //localhost:8080/users/findQuery?username=TEST GET we're going to extract the username TEST
