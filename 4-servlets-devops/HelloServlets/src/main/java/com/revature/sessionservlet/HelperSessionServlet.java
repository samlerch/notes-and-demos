...
public class HelperSessionServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SuperVillain vill = (SuperVillain) session.getAttribute("the-villain"); // we search for the object 
		//that we bound to the session based on the attribute we set in the SessionServlet's doGet() method.
