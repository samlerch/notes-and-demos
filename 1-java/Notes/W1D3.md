...
- Complete the Following Hackerrank Problems [here](http://www.hackerrank.com/june-15th)
- Explore the String Class and Array Class and theirs various methods
- Do your best to get Maven Installed, we'll be working with it tomorrow and Friday
- Study notes from the previous days and work to answer all the questions on the QC study guide
